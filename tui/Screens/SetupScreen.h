...
namespace Memory::tui {
    ...
    public:
        ...
        explicit SetupScreen(const ElementParent &parent) : Sheet(parent),
                                                            ...
                                                            height({2, 1}, InputRestrictions{true, false,false,false}),
                                                            player1Text({9, 1},"Player 1:"),
                                                            player2Text({9, 1}, "Player 2:"),
                                                            widthText({40, 1}, "Width:"),
                                                            heightText({40, 1},"Height:"),
                                                            firstInstruction({38,1},"Please enter the names of the players"),
                                                            secondInstruction({47,1},"Please enter the width and height of the board"),
